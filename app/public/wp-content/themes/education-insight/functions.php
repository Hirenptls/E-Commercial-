            ...
            <div class="notice notice-info is-dismissible" data-notice="get_started_notice">
                <div class="notice-div">
                    ...
                    <div class="notice-buttons-box">
                        ...
                        <a class="button-primary theme-install" href="themes.php?page=education-insight-guide-page"><?php _e('Begin Installation', 'education-insight'); ?></a> 
                    </div>
                </div>
            </div>
        <?php
...
function education_insight_setup() {
	...
	load_theme_textdomain( 'education-insight', get_template_directory() . '/languages' );
