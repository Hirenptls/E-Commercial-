...
function education_insight_customize_register( $wp_customize ) {
	...
	if ( $wp_customize->get_section( 'colors' ) ) {
        $wp_customize->get_section( 'colors' )->title = __( 'Global Colors', 'education-insight' );
        $wp_customize->get_section( 'colors' )->priority = 2;
    }

    $wp_customize->add_setting( 'education_insight_global_color_heading', array(
		'default'           => '',
		'transport'         => 'refresh',
		'sanitize_callback' => 'sanitize_text_field',
	) );
	$wp_customize->add_control( new Education_Insight_Customizer_Customcontrol_Section_Heading( $wp_customize, 'education_insight_global_color_heading', array(
			'label'       => esc_html__( 'Global Colors', 'education-insight' ),
			'section'     => 'colors',
			'settings'    => 'education_insight_global_color_heading',
			'priority'       => 1,

	) ) );

    $wp_customize->add_setting('education_insight_primary_color', array(
	    'default' => '#e9a502',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_primary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Color', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_heading_color', array(
	    'default' => '#2c2c2c',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_heading_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Heading Color', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_text_color', array(
	    'default' => '#666c6e',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_text_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Theme Text Color', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_primary_light', array(
	    'default' => '#ffbd0a',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_primary_light', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color Light', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_primary_fade', array(
	    'default' => '#fff8e7',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_primary_fade', array(
	    'section' => 'colors',
	    'label' => esc_html__('theme Color fade', 'education-insight'),
	 
	)));


	$wp_customize->add_setting('education_insight_secondary_color', array(
	    'default' => '#ef5921',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_secondary_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Second Color', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_third_color', array(
	    'default' => '#91b707',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_third_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Third Color', 'education-insight'),
	 
	)));

	$wp_customize->add_setting('education_insight_fourth_color', array(
	    'default' => '#2ec7c3',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_fourth_color', array(
	    'section' => 'colors',
	    'label' => esc_html__('Fourth Color', 'education-insight'),
	 
	)));

  	$wp_customize->add_setting('education_insight_service_bg', array(
	    'default' => '#271706',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_service_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('Service Bg color', 'education-insight'),
	)));

	$wp_customize->add_setting('education_insight_footer_bg', array(
	    'default' => '#2c2c2c',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_footer_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('Footer Bg color', 'education-insight'),
	)));

	$wp_customize->add_setting('education_insight_post_bg', array(
	    'default' => '#ffffff',
	    'sanitize_callback' => 'sanitize_hex_color',
	    'transport' => 'refresh',
	));

	$wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'education_insight_post_bg', array(
	    'section' => 'colors',
	    'label' => esc_html__('sidebar/Blog Post Bg color', 'education-insight'),
	)));
	...
	if ( class_exists( 'WooCommerce' ) ) { 
		$wp_customize->add_section('education_insight_woocoomerce_section',array(
	        'title' => __('Custom Woocommerce Settings', 'education-insight'),
	        'panel' => 'woocommerce',
	        'priority' => 4,
	    ) );
