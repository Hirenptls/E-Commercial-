 ...
 */
	...
	$wp_customize->add_setting('education_insight_slider_opacity',array(
        'default' => '0.7',
        'sanitize_callback' => 'education_insight_sanitize_choices'
	));
	$wp_customize->add_control('education_insight_slider_opacity',array(
		'type' => 'radio',
		'label'     => __('Slider Opacity', 'education-insight'),
		'section' => 'education_insight_slider_section',
		'type' => 'select',
		'choices' => array(
			'0' => __('0','education-insight'),
			'0.1' => __('0.1','education-insight'),
			'0.2' => __('0.2','education-insight'),
			'0.3' => __('0.3','education-insight'),
			'0.4' => __('0.4','education-insight'),
			'0.5' => __('0.5','education-insight'),
			'0.6' => __('0.6','education-insight'),
			'0.7' => __('0.7','education-insight'),
			'0.8' => __('0.8','education-insight'),
			'0.9' => __('0.9','education-insight'),
