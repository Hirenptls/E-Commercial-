    ...
    <?php if( get_theme_mod('education_insight_popular_courses_heading') != '' || get_theme_mod('education_insight_popular_courses_setting') != ''){ ?>
      <section id="course-cat">
        <div class="container">
          ...
          <div class="row">
            <?php
            $education_insight_catData1=  get_theme_mod('education_insight_popular_courses_setting');
            if($education_insight_catData1){
            $education_insight_page_query = new WP_Query(array( 

              'category_name' => esc_html($education_insight_catData1 ,'education-insight'),
