...
function minimal_education_customize( $wp_customize ) {
  ...
  //color
  $wp_customize->add_setting('minimal_education_primary_color', array(
      'default' => '#01b509',
      'sanitize_callback' => 'sanitize_hex_color',
      'transport' => 'refresh',
  ));

  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'minimal_education_primary_color', array(
      'section' => 'colors',
      'label' => esc_html__('Theme Color', 'minimal-education'),
   
  )));
  
  $wp_customize->add_setting('minimal_education_primary_fade', array(
      'default' => '#e5f7e6',
      'sanitize_callback' => 'sanitize_hex_color',
      'transport' => 'refresh',
  ));

  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'minimal_education_primary_fade', array(
      'section' => 'colors',
      'label' => esc_html__('Theme Color Fade', 'minimal-education'),
   
  )));
  $wp_customize->add_setting('minimal_education_secondary_color', array(
      'default' => '#e98401',
      'sanitize_callback' => 'sanitize_hex_color',
      'transport' => 'refresh',
  ));

  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'minimal_education_secondary_color', array(
      'section' => 'colors',
      'label' => esc_html__('Second Color', 'minimal-education'),
   
  )));
  $wp_customize->add_setting('minimal_education_third_color', array(
      'default' => '#238fbb',
      'sanitize_callback' => 'sanitize_hex_color',
      'transport' => 'refresh',
  ));

  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'minimal_education_third_color', array(
      'section' => 'colors',
      'label' => esc_html__('third Color', 'minimal-education'),
   
  )));
  $wp_customize->add_setting('minimal_education_fourth_color', array(
      'default' => '#ed5927',
      'sanitize_callback' => 'sanitize_hex_color',
      'transport' => 'refresh',
  ));

  $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'minimal_education_fourth_color', array(
      'section' => 'colors',
      'label' => esc_html__('fourth Color', 'minimal-education'),
